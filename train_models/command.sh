...
python train_models.py --tensorboard --epochs 20 -b 64 --print-freq 10 --dataset rodent_256_scale --model resnet18 --lr 0.01 --lr-decay 0.2 --name nmp --imagenet --augment --no-weight-class

python train_models.py --tensorboard --epochs 20 -b 64 --print-freq 10 --dataset rodent_256_scale --model resnet18 --lr 0.01 --lr-decay 0.2 --name nmp --imagenet --augment --weight-class

python train_models.py --tensorboard --epochs 20 -b 64 --print-freq 10 --dataset rodent_256_scale --model resnet18 --lr 0.01 --lr-decay 0.2 --name nmp --augment --weight-class
